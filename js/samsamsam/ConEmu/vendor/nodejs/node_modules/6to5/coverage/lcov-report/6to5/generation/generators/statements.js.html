...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">95.9% <small>(117 / 122)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">95.87% <small>(116 / 121)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cstat-no" title="statement not covered" >  this.keyword("with");</span>
...
<span class="cstat-no" title="statement not covered" >  print.block(node.body);</span>
};
&nbsp;
...
exports.TryStatement = function (node, print) {
  ...
  this.space();
  print(node.handler);
  <span class="missing-if-branch" title="else path not taken" >E</span>if (node.finalizer) {
    this.space();
    this.push("finally ");
