...
<head>
	...
	<link rel="stylesheet" type="text/css" href="json_user_online.css" />
	...
	<script type="text/javascript">
		...
		*/
		...
		function validateUser() {
			...
			req.open('POST', 'json_user_online_user_auth.php', true);
		...
		*/
		...
		req.open('POST', 'json_user_online_get_online_users.php', true);
		req.setRequestHeader("Content-Type", "text/plain");
