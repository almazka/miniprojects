...
*/
	...
	function wp_ulike_options() {
		...
		add_option('wp_ulike_text', __('Лайк','alimir'), '', 'yes');
		add_option('wp_ulike_btn_text', __('Понравилось','alimir'), '', 'yes');
		add_option('wp_ulike_dislike_text', __('Не понравилось','alimir'), '', 'yes');
	}
