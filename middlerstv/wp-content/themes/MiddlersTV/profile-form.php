...
<div class="login profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form id="your-profile" action="<?php $template->the_action_url( 'profile' ); ?>" method="post">
		...
		<tr>
			...
			<td><input type="text" name="user_login" id="user_login" value="<?php echo esc_attr( $profileuser->user_login ); ?>" disabled="disabled" class="regular-text" /> <span class="description"><?php _e( 'Ваше имя не может быть изменено.', 'theme-my-login' ); ?></span></td>
		</tr>
		...
		<tr id="password">
			...
			<td><input type="password" name="pass1" id="pass1" size="16" value="" autocomplete="off" /> <span class="description"><?php _e( 'If you would like to change the password type a new one. Otherwise leave this blank.' ); ?></span><br />
				...
				<div id="pass-strength-result"><?php _e( 'Индикатор надежности', 'theme-my-login' ); ?></div>
				<p class="description indicator-hint"><?php _e( 'Совет: Пароль должен быть минимум из 7 символов.' ); ?></p>
			</td>
		</tr>
		<?php endif; ?>
		</table>
